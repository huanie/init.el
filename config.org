...
#+begin_src emacs-lisp
  ...
  (use-package meow
    ...
    (setq meow-mode-state-list
          (cons '(text-mode . insert)
                (cons '(vterm-mode . insert) meow-mode-state-list)))
    (meow-global-mode 1))
#+end_src
* User Interface
** Unclutter
...
#+begin_src emacs-lisp
  (use-package nano-modeline
    ...
    (add-hook 'messages-buffer-mode-hook #'nano-modeline-messages-mode)
...
#+begin_src emacs-lisp
  ...
  (add-to-list 'eglot-server-programs
               `(scala-mode . (,(expand-file-name "./metals"))))
